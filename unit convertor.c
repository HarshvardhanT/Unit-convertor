...
int main() {
  ...
  int userinputUSDtoAS; // User inputted for USD to JPY;
  int userinputUSDtoRS; // User inputted for USD to RMB;
  ...
  float USDtoAS; // stores the converted USD->JPY;
  float USDtoRS; // stores the converted USD->RMB;
  ...
  if(category == 'T'){
      ...
      printf("Enter 2 for USD to AS. \n");
      printf("Enter 3 for USD to RS. \n");
      ...
      if(currencyChoice == 1){
          ...
          printf("Please enter the USD amount: \n");
          scanf("%d",&userinputUSDtoAS);
          USDtoAS = userinputUSDtoAS * 1.14;
          printf("AS: %.2f",USDtoAS);
      }
      else if(currencyChoice == 3) {
        printf("Please enter the USD amount: \n");
        scanf("%d",&userinputUSDtoRS);
        USDtoRS = userinputUSDtoRS * 78.14;
